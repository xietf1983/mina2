...
final class _AMD_MssWeb_QueryAlarmStorage extends IceInternal.IncomingAsync implements AMD_MssWeb_QueryAlarmStorage
{
    public
    _AMD_MssWeb_QueryAlarmStorage(IceInternal.Incoming in)
    {
        super(in);
    }
